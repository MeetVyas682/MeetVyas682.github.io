...
struct data_node * array[10000000];                 // Please note that global allocation is done in order to pass the test case which is causing memory error
                                                    // Equivalent allocation which depends on number of vertices has been written in comments
                                                    // on line number 180
